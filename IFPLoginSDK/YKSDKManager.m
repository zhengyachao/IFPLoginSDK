...
{
    NSString *url =[NSString stringWithFormat:@"https://api.weixin.qq.com/sns/oauth2/access_token?appid=%@&secret=%@&code=%@&grant_type=authorization_code",@"wx0bceb2176071ae4b",@"c41f99c5cdfb16b9f6621ea1a1b31ec1",code];
